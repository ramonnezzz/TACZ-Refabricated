...
public class ClientMessageRefitGun implements FabricPacket {
    public static final PacketType<ClientMessageRefitGun> TYPE = PacketType.create(Identifier.fromNamespaceAndPath(GunMod.MOD_ID, "c2s_player_refit"), ClientMessageRefitGun::new);
